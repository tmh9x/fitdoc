...
function WorkoutCardLarge({
  ...
  return (
    <article className="grid grid-cols-2 grid-rows-2 w-80 rounded-3xl">
      ...
      <div className="w-48 col-start-2 col-end-3 row-start-2 row-end-3 bg-transparent place-self-end justify-self-end">
        <p className="pt-1 pb-1 pl-3 pr-3 font-sans text-center bg-secondary rounded-tl-xl rounded-br-xl">
          {name}
        </p>
      </div>
    </article>
